...
The circles represent neurons while the lines represent synapses. The role of a synapse is to take the sum of products of the inputs and **weights**. After, an activation function is applied to return an output.
